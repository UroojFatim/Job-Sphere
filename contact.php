    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                ...
                <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600">Need Any Help Regarding to Jobline!
                </p>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    <p class="mt-3 mb-12 text-lg text-gray-600">
                        Just Send us a message our team will be ready to help you to solve any problem or help in any case related to jobline!
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 ">Makhdoom Ahmed Ali Model Town</p>
                                <p class="text-gray-600 ">Hala New, Sindh</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600">Mobile: +92 301-2345678</p>
                                <p class="text-gray-600">Mail: mailme@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
